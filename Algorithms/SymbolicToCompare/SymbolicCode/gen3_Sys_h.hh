...
#ifndef GEN3_SYS_H_HH
#define GEN3_SYS_H_HH
...
namespace SymExpression
{
  ...
  inline void gen3_Sys_h(Eigen::MatrixXd &p_output1, const Eigen::VectorXd &var1,const Eigen::VectorXd &var2)
  {
    // Check
    // - Inputs
    ...
    gen3_Sys_h_raw(p_output1.data(), var1.data(),var2.data());
    }
