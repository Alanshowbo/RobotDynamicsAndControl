...
for i = 1:P.NB
    ...
    if strcmp(LinkName,'pelvis')
        addPelvisImu(printSDFLine,ind3,ind1)
    end
    ...
    if (Visuals.Type(i,1)==1)
        ...
        printSDFLine(ind3,['<visual name="' LinkName '_visual_mesh">']);
            printSDFLine(ind4,'<geometry>');
                ...
                printSDFLine(ind5,'</mesh>');
            printSDFLine(ind4,'</geometry>');
            addMaterial_DarkBlue(printSDFLine,ind4,ind1);
    ...
    if (Visuals.Type(i,6)==1)
        printSDFLine(ind3,['<visual name="' LinkName '_visual_jointCylinder">']);
            printSDFLine(ind4,'<geometry>');
                ...
                printSDFLine(ind5,'</cylinder>');
            printSDFLine(ind4,'</geometry>');
            addMaterial_Black(printSDFLine,ind4,ind1);
    ...
    if (Visuals.Type(i,2)==1)
        printSDFLine(ind3,['<visual name="' LinkName '_visual_box">']);
            printSDFLine(ind4,'<geometry>');
                ...
                printSDFLine(ind5,'</box>');
            printSDFLine(ind4,'</geometry>');
            addMaterial_White(printSDFLine,ind4,ind1);
    ...
    if (Visuals.Type(i,3)==1)
        printSDFLine(ind3,['<visual name="' LinkName '_visual_box">']);
            printSDFLine(ind4,'<geometry>');
                printSDFLine(ind5,'<cylinder>');
                    printSDFLine(ind6,['<length>' num2str(Visuals.CYLINDER(i,1)) '</length>']);
                    printSDFLine(ind6,['<radius>' num2str(Visuals.CYLINDER(i,2)) '</radius>']);
                printSDFLine(ind5,'</cylinder>');
            printSDFLine(ind4,'</geometry>');
            addMaterial_White(printSDFLine,ind4,ind1);
            printSDFLine(ind4,['<pose>' num2str(Visuals.CYLINDER(i,3)) ' ' num2str(Visuals.CYLINDER(i,4)) ' ' num2str(Visuals.CYLINDER(i,5)) ...
            ' ' num2str(Visuals.CYLINDER(i,6)*pi/180) ' ' num2str(Visuals.CYLINDER(i,7)*pi/180) ' ' num2str(Visuals.CYLINDER(i,8)*pi/180) '</pose>']);
        printSDFLine(ind3,'</visual>');
    end
...
function addPelvisImu(printSDFLine,ind,ind1)
    accelBiasMean = 0.1;
...
%% material values
function addMaterial_White(printSDFLine,ind,ind1)
...
function addMaterial_DarkBlue(printSDFLine,ind,ind1)
    printSDFLine(ind,'<material>');
...
function addMaterial_Black(printSDFLine,ind,ind1)
    printSDFLine(ind,'<material>');
...
function addMaterial_XOMaroon(printSDFLine,ind,ind1)
    printSDFLine(ind,'<material>');
